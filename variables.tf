...
variable "enable_persistent_storage_1" {
  description = "Deploy 2 filestores for Solr indexing"
  type        = bool
  default     = true
}

variable "enable_persistent_storage_2" {
  description = "Deploy 2 extra filestores for Solr indexing for Control Plane with HA"
  type        = bool
  default     = true
}

variable "carbondb_fileshare_1" {
  default     = "carbondb1"
  description = "File share name"
  type        = string
}

variable "solr_fileshare_1" {
  default     = "solr1"
  description = "File share name"
  type        = string
}

variable "carbondb_fileshare_2" {
  default     = "carbondb2"
  description = "File share name"
  type        = string
}

variable "solr_fileshare_2" {
  default     = "solr2"
  description = "File share name"
  type        = string
}
