...
module "email_channel_primary" {
  source              = "./modules/gcp/Notification-Channel"
...
module "alert_policy_container_cpu" {
  source                      = "./modules/gcp/Alert-Policy"
  environment                 = var.environment
  ...
  alert_renotify_interval     = var.container_cpu_alert_renotify_interval
...
module "alert_policy_container_memory" {
  ...
  alert_renotify_interval     = var.container_memory_alert_renotify_interval
  alert_notification_channels = [module.email_channel_primary.name]
...
module "alert_policy_container_restart_count" {
  ...
  alert_renotify_interval            = var.container_restart_alert_renotify_interval
...
module "alert_policy_node_cpu" {
  ...
  alert_renotify_interval     = var.node_cpu_alert_renotify_interval
  alert_notification_channels = [module.email_channel_primary.name]
...
module "alert_policy_node_memory" {
  ...
  alert_renotify_interval     = var.node_memory_alert_renotify_interval
  alert_notification_channels = [module.email_channel_primary.name]
